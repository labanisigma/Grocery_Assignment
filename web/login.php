...
if(isset($_POST['login'])) {
    ...
    //echo "select `UserID` from `users` where  (email='$email' || phone='$email') && password='$password'";
    //  exit();
    $query = ("select *  from users  where  (UserEmail='$email'  AND UserPassword='$password') OR (UserPhone='$email' AND UserPassword='$password') ");
